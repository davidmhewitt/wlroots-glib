...
#define WLROOTS_TYPE_XCURSOR_MANAGER (wlroots_xcursor_manager_get_type())

G_DECLARE_FINAL_TYPE (WlrootsXCursorManager, wlroots_xcursor_manager, WLROOTS, XCURSOR_MANAGER, GObject)
